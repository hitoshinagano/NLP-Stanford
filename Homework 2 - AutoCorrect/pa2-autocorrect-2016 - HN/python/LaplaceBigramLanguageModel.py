  ...
  def train(self, corpus):
    ...
    for sentence in corpus.corpus:
      for datum in sentence.data:
        ...
        previousWord = word
    #pass
    # considerar tambem os tags <\s> como parte do vocabulario
    # e avaliar performance do corretor
    ...
    # tenho que tirar todos os keys com (word, '<s>')
    #self.LaplaceBigramCounts.pop(('<\s>', word))
